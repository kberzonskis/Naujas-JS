...
const luckyNumberss = [77, 88, 88]
console.log(luckyNumberss)

const studentss =  [ 'Jonas']
console.log(studentss)

const dictionary = ['pomidoras', 'druska']
...
const dictionary1 = ['pomidoras', 'agurkas', 'bulve', 'kefyras', 'druska', 'svogunu laiskai', 'lasiniai'];

// Patiekalui reikes: a, b, c, d.
const sentence12 = 'Patiekalui reikes: ' + dictionary1[0] + ', ' + dictionary1[1] + ', ' + dictionary[2] + ', ' + dictionary[3] + ', ' + dictionary[4] + ', ' + dictionary[5] + ', ' + dictionary[6] + '.';
