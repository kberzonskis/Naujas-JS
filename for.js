...
for (let i = 4; i <= 5; i++) {console.log('number:', i)} 

console.log('---------');

for (let i = 4; i >= 0 ; i--) {console.log('number:', i)} 
...
for (let k =4; k<5; k += 0.2 ) { console.log(k)} 
/* nenaudoi skaiciu pvz 0,1*/ 


for (let k =0; k<10; k ++ ) { console.log(k/10)} 
